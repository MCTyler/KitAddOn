...
public class MyFishingHook extends EntityFishingHook{
	private Snowball sb;
	...
	public MyFishingHook(org.bukkit.World world, EntityHuman entityhuman){
	...
	public void h(){
		if ((!this.lastControllerDead) && (this.controller.dead)) {
			((Player)this.owner.getBukkitEntity()).sendMessage(org.bukkit.ChatColor.GREEN + "You are now hooked!");
		}
